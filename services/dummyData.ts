...
export const DUMMY_COURSES: Omit<Course, 'id'>[] = [
  ...
  },
  {
    ...
    coverImage: 'https://images.unsplash.com/photo-1544383835-bda2bc66a55d?q=80&w=2070&auto=format&fit=crop',
    url: '#',
  },
  {
  ...
  },
  {
    ...
    instructor: 'MIT',
    coverImage: 'https://images.unsplash.com/photo-1485827404703-89b55fcc595e?q=80&w=1974&auto=format&fit=crop',
